...
public class ECB_editor : Form
{
	...
	{
		string path = null;
		switch (FileIO.load_file(ref spritebuf, ref path, berry_sp_filter))
		{
		case 1184:
	...
	{
		string path = null;
		switch (FileIO.load_file(ref paletebuf, ref path, berry_sp_filter))
		{
		case 32:
	...
	private void PphelpClick(object sender, EventArgs e)
	{
	...
	private void Modifier_helpClick(object sender, EventArgs e)
	{
