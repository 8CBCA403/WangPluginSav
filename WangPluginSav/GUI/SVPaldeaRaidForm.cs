...
{
    public partial class SVPaldeaRaidForm : Form
    {
        ...
        public SVPaldeaRaidForm(ISaveFileProvider sav, IPKMView edit)
        {
            SAV = sav;
            PKMEditor = edit;
            InitializeComponent();
    ...
    private void ImportSeed_BTN_Click(object sender, EventArgs e)
        ...
        private void ShinyCarPaldea_BTN_Click(object sender, EventArgs e)
        {
            if (SAV.SAV is SAV9SV sv)
            {
                TeraRaidDetail[] allRaids = sv.RaidPaldea.GetAllRaids();
